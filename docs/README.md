<p align="center">
  <a href="https://docs.sanaei.dev">
    <picture>
      ...
      <img src="public/logo-light.png" alt="3x-node" width="180" />
    </picture>
  </a>
</p>

<h1 align="center">3x-node Documentation</h1>

<p align="center">
  The official documentation and product site for
  <a href="https://github.com/opxqo/3x-node"><b>3x-node</b></a> —
...
<p align="center">
  ...
  <a href="https://github.com/opxqo/3x-node/actions/workflows/docs-ci.yml"><img src="https://github.com/opxqo/3x-node/actions/workflows/docs-ci.yml/badge.svg" alt="CI" /></a>
...
This directory (`docs/` in the [3x-node](https://github.com/opxqo/3x-node) monorepo) contains
...
The documentation walks you through 3x-node from first install to day-to-day operation:
