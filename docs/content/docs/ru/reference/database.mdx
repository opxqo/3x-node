---
title: База данных
description: Хранилища данных 3x-node — SQLite (по умолчанию) и PostgreSQL — путь к базе данных, пул соединений и миграция с SQLite на PostgreSQL.
icon: Database
---

3x-node хранит всё — входящие подключения, клиентов, настройки — в базе данных.
