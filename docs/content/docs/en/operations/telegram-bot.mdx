---
title: Telegram Bot
description: Connect a Telegram bot to 3x-node for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

3x-node can drive a Telegram bot for monitoring, alerts, backups, and remote
