---
title: Security
description: Harden 3x-node — panel auth and 2FA, Fail2ban IP limits, firewall rules, BBR, and staying current.
icon: ShieldCheck
---
...
3x-node installs and configures for you (enabled by default on script installs, and
...
Update 3x-node and Xray-core regularly — security fixes land in new releases. Watch
the [releases page](https://github.com/opxqo/3x-node/releases) and see
