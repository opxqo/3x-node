---
title: Installation
description: Install 3x-node via the official script (stable, pinned, or dev-latest), unattended/cloud-init, or Docker — and choose SQLite or PostgreSQL.
icon: Download
---

3x-node runs on a wide range of Linux distributions — Ubuntu, Debian, Armbian,
...
[releases page](https://github.com/opxqo/3x-node/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/opxqo/3x-node/tree/main/deploy)
