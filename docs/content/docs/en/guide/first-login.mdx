---
title: First Login
description: Find your generated 3x-node credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
3x-node supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
