---
title: 3x-node Documentation
description: Official documentation for 3x-node — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**3x-node** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is 3x-node?](/docs/guide) first — it explains how the panel, Xray-core, and
