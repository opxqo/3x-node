---
title: Contributing
description: How to contribute to 3x-node and to translate this documentation.
icon: GitPullRequestArrow
---

3x-node is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

3x-node is free and open source, built and maintained in the open. If it's useful
...
- **Star** the [repository](https://github.com/opxqo/3x-node) and share the
  project.
- **Join** the Telegram channel [@XrayUI](https://t.me/XrayUI) to follow news and
  help others.

## Contribute to 3x-node

- Read the project's `CONTRIBUTING.md` in the
  [repository](https://github.com/opxqo/3x-node).
