---
title: FAQ
description: Frequently asked questions about 3x-node — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is 3x-node free and open source?

Yes. 3x-node is open source under the GPL-3.0 license. The source is on
[GitHub](https://github.com/opxqo/3x-node).
...
## How is 3x-node different from x-ui?

3x-node is an enhanced fork of the original X-UI project. It adds broader protocol
...
[releases page](https://github.com/opxqo/3x-node/releases).
...
[GitHub](https://github.com/opxqo/3x-node/issues). For common problems, start
