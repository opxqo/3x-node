...
description: Fix common 3x-node problems — the panel won't start, 502 errors, certificate issues, and clients that can't connect.
icon: Wrench
---
...
<Callout type="info">
  ...
  [GitHub issues](https://github.com/opxqo/3x-node/issues) — your symptom has
