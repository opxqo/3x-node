---
title: API Reference
description: The 3x-node panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The 3x-node panel exposes a REST API for automation. These pages are generated from
