---
title: Subscription
description: Run the 3x-node subscription server — base64/JSON/Clash formats, ports and paths, TLS, response headers, and custom templates.
icon: Rss
---
...
routing, policy) plus a `proxy` outbound pointing at the inbound. 3x-node emits a
