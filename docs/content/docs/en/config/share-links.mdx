---
title: Share Links
description: 3x-node share-link formats (vless, vmess, trojan, ss, hysteria2, mtproto), the remark template variables, and an in-browser link inspector.
icon: Link
---

3x-node generates a **share link** (and QR code) for each client. Client apps such
