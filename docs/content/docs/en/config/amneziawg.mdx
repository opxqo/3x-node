---
title: AmneziaWG
description: Set up an AmneziaWG inbound in 3x-node — obfuscation parameters, native IPv6, per-client port-forwarding, and routing client traffic through Xray.
icon: Lock
---
