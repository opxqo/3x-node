...
description: Create inbounds in 3x-node — protocols, transports, traffic reset and expiry, and fallbacks that serve multiple protocols on one port.
...
inbound. In 3x-node, fallbacks are managed in the panel (a master inbound's
