---
title: مستندات 3x-node
description: مستندات رسمی 3x-node — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**3x-node** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [3x-node چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
