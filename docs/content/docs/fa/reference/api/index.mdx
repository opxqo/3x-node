---
title: مرجع API
description: REST API پنل 3x-node — احراز هویت، inboundها، کلاینت‌ها، آمار سرور و موارد دیگر، تولیدشده از مشخصات OpenAPI.
icon: Webhook
---

پنل 3x-node یک REST API برای خودکارسازی در اختیار می‌گذارد. این صفحات از مشخصات
