...
description: مدیریت 3x-node با منوی x-ui و خط فرمان — به‌روزرسانی (پایدار، dev یا نسخه‌های قدیمی)، تغییر تنظیمات و حذف تمیز و کامل.
icon: RefreshCw
---
...
| 6     | Uninstall                              | حذف 3x-node (در ادامه ببینید)                                |
