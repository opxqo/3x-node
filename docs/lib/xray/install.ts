// Pure builders for 3x-node install commands (script + Docker). No React/DOM.
...
const REPO_RAW = 'https://raw.githubusercontent.com/opxqo/3x-node/main/install.sh';
const IMAGE = 'ghcr.io/opxqo/3x-node:latest';
