...
// The 3x-node product repository — used for the navbar GitHub link,
...
// Where these docs live in the 3x-node monorepo — used for "Edit on GitHub" links.
...
// AI-generated interactive wiki of the 3x-node codebase.
export const deepWikiUrl = `https://deepwiki.com/${productRepo.user}/${productRepo.repo}`;

// Official 3x-node community channel on Telegram (announcements & support).
