# 3x-node Custom Subscription Templates

3x-node can render your users' subscription pages from your own custom HTML templates.

## How to use a Custom Template

1. Go to the 3x-node panel settings.
...
> **Note:** 3x-node does not ship any templates by default. Create your own template folder anywhere
