...
import (
	...
	"github.com/opxqo/3x-node/v3/internal/web/session"

	"github.com/gin-gonic/gin"
)

// APIController handles the main API routes for the 3x-node panel, including inbounds and server management.
