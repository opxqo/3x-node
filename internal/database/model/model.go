// Package model defines the database models and data structures used by the 3x-node panel.
package model
...
// User represents a user account in the 3x-node panel.
type User struct {
...
// Setting stores key-value configuration settings for the 3x-node panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote 3x-node panel registered with the central panel.
