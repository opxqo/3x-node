...
version=0.1.20
case "$(uname -m)" in
    x86_64) arch=amd64; expected=8189b77774f85fea84546afb6ddf55390e39d44bc14dfacc4b9344589e1db6f9;;
    aarch64) arch=arm64; expected=56096b44151979a0d8a309fc21e1515b341f74979c03678e44bc8a4c770752fd;;
