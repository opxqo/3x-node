...
version=0.1.21
case "$(uname -m)" in
    x86_64) arch=amd64; expected=6f32127ba24c2fad7b703cb5df862ec8e56e9438328fd4dfe2c0ccacd1520f58;;
    aarch64) arch=arm64; expected=afa61654aac3ea7ab28041c62e67480b0a8e510b32428efd989b8f6a056a94e6;;
